    ...
    return Scaffold
      (
        appBar: AppBar
          ...
          title: Text('H?p d?ng', style: TextStyle(color: Colors.black, fontWeight: FontWeight.w700)),
          // actions: <Widget>
          // [
          //   Container
          //   (
                    ...
                    child: Padding
                      ...
                      child: Row
                        ...
                        [
                          ...
                          Text('T?o h?p d?ng', style: TextStyle(color: Colors.white))
                        ],
                      ),
                    ),
                  ),
                            ...
                            child: Column
                              ...
                              [
                                ...
                                Column
                                  ...
                                  children: <Widget>
                                  [
                                    Text('H?p d?ng example 1', style: TextStyle(color: Colors.blueAccent)),
                                    Row
                                      (
                                      mainAxisAlignment: MainAxisAlignment.start,
                                      crossAxisAlignment: CrossAxisAlignment.center,
                                    ...
                                    Padding
                                      ...
                                      child: Material
                                        ...
                                        child: Padding
                                          ...
                                          child: Text('Ðã duy?t', style: TextStyle(color: Colors.white)),
                                        ),
                                      ),
                                    ),
                                  ],
                            ...
                            child: Column
                              ...
                              [
                                ...
                                Column
                                  ...
                                  children: <Widget>
                                  [
                                    Text('H?p d?ng example 2', style: TextStyle(color: Colors.white)),
                                    Row
                                      (
                                      mainAxisAlignment: MainAxisAlignment.start,
                                      crossAxisAlignment: CrossAxisAlignment.center,
                                ...
                                Row
                                  ...
                                  children: <Widget>
                                  [
                                    Text('Ngày l?p:', style: TextStyle(color: Colors.white)),
                                    Padding
                                      (
                                      padding: EdgeInsets.symmetric(horizontal: 4.0),
                                      child: Text('17/11/2019', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w700)),
                                    ),
                                    /*Text('(Ðã h?y)', style: TextStyle(color: Colors.white)),*/
                                    Padding
                                      (
                                      padding: EdgeInsets.symmetric(horizontal: 4.0),
                                      child: Material
                                        ...
                                        child: Padding
                                          (
                                          padding: EdgeInsets.all(4.0),
                                          child: Text('Ðã h?y', style: TextStyle(color: Colors.white)),
                                        ),
                                      ),
                                    ),
                                  ],
